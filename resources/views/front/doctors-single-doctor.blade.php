@include('front.header')
    ...
    <section class="page-title page-title-layout6">
      <div class="bg-img"><img src="{{asset('assets/images/backgrounds/7.jpg')}}" alt="background"></div>
      <div class="container">
        <div class="row">
        ...
        <div class="row">
              ...
              <div class="widget widget-member shifted-top">
                <div class="member mb-0">
                  ...
                  <div class="member__info">
                    ...
                    <p class="member__job">{{$doctor->speciality}}</p>
                    <p class="member__desc">{{substr($doctor->biograph, 300, 50)}}</p>
          ...
          <div class="col-sm-12 col-md-12 col-lg-8">
            <div class="text-block mb-50">
              ...
              <p class="text-block__desc mb-20 font-weight-bold color-secondary">{{substr($doctor->biograph, 300, 200)}}.</p>
              <p class="text-block__desc mb-20">{{substr($doctor->biograph, 400, 100)}}.</p>
              <p class="text-block__desc mb-20">{{substr($doctor->biograph, 33, 70)}}.</p>
            </div><!-- /.text-block -->
            <ul class="details-list list-unstyled mb-60">
              ...
              <li>
                ...
                <div class="details__content">
                  <p class="mb-0">{{$doctor->office}} </p>
                </div>
              </li>
              <li>
                <h5 class="details__title">University</h5>
                <div class="details__content">
                  <p class="mb-0">{{$doctor->university}} </p>
                </div>
              </li>
            </ul>
            <div class="text-block mb-50">
            ...
            <section class="contact-layout4 bg-overlay bg-overlay-secondary-gradient pb-50 pb-50">
              <div class="bg-img"><img src="{{asset('assets/images/banners/3.jpg')}}" alt="banner"></div>
